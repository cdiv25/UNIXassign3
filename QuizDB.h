...
char *QuizQ[] = {"In a 32-bit system architecture, each process can address 4 Giga bytes of memory. Y or N?",
                 ...
                 "What is the program that allows users to run programs with security privileges of another user? "
                 "(Hint: Answer is a 4-letter word.)",
                 ...
                 "What is the system call that returns two completely independent copies of the original process? "
                 "(Hint: A four-letter word)",
                 "All the threads inside a process have access to the same global, shared memory. Y or N?",
                 "What is the software interrupt sent to a program to indicate that an important event has happened? "
                 "(Hint: a six-letter word)",
                 ...
                 "What is the interprocess communication (IPC) mechanism that allows data to be exchanged between "
                 "applications on different hosts connected by a network? (Hint: a six-letter word.)",
...
char *QuizA[] = {"Y",    "Y", "Y",      "Y",    "sudo", "N",      "N", "fopen",     "fclose", "Y",  "NULL",
                 "NULL", "N", "N",      "Y",    "N",    "Y",      "Y", "assembler", "Y",      "Y",  "Y",
                 "N",    "Y", "Y",      "fork", "Y",    "signal", "2", "15",        "11",     "17", "Y",
                 "Y",    "N", "socket", "Y",    "Y",    "N",      "Y", "N",         "Y",      "Y"};
